  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      type: "bot",
      content: "Hi! 👋 I'm Valsia's AI assistant. I'm here to teach you new skills step by step. Just tell me what you'd like to learn, and I'll break it down into easy lessons with practical tasks. Let's get started!",
      timestamp: new Date(),
    },
  ])
